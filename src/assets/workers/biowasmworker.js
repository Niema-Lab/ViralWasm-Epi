...
const runTn93 = async (inputFile) => {
	...
	// run tn93 in BioWASM
	const output = await CLI.exec("tn93 -o pairwise-distances.csv -t 1.0 -a resolve -g 1.0 -f csv -l 1 -d \":\" -u 1 input.fas");
	self.postMessage({ 'log': output })
